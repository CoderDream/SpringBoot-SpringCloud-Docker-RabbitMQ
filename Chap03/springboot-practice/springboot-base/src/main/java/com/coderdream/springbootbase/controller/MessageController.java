package com.coderdream.springbootbase.controller;

import com.coderdream.springbootbase.util.MessageUtil;
...
public class MessageController {
    ...
    public Object message() {
        ...
        map.put("welcome.url",
            this.messageSource.getMessage("welcome.url", null,
                Locale.getDefault()));
        map.put("welcome.msg",
            this.messageSource.getMessage("welcome.msg", new Object[]{"李兴华"},
                new Locale("en", "US")));
        return map;
    }
